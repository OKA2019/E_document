...
<br>
            <div class="card">
                ...
                <form action="controllers/authentification.php" method="post" class="form_connexion">
                    <div id="error-txt">
                    ...
                    <div class="name-details">
                        <div class="con_details">
                            <label>Pseudo</label>
                            <input type="text" id="users" placeholder="Nom d'utilisateur" name="pseudo" required>
                        </div>
                        <div class="con_details">
                            <label>Mot de passe</label>
                            <input type="password" id="pswd" placeholder="Mot de passe" name="mdp" required>
                    ...
                    <label for=""> Vous n'est pas de compte ? <br> Inscrivez-vous en <a href="index.php?page=inscription">cliquant sur ici</a>  </label>
                </form>
          </div>
