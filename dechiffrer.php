            ...
            <div class="profile-nav col-md-3">
              ...
              <?php
                ...
                ?> 
                    ...
                    <li class="active" ><a href="index.php?page=recu"> <i class="fa fa-bell-o"></i> Documents reçus</a></li>
            ...
            <div class="profile-info col-md-9">
                <div class="card" style="height: 900px;">
                    <form action="my-script.php" enctype="multipart/form-data" method="post">
                        <embed class="carv" src="assets/file/TP_3.pdf" width="700" height="800px" type="application/pdf"
