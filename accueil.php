...
<body>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Bienvenue sur E-document</h1>
      <h2>Une application qui reponds qui securise vos envois de documents et &amp; bien plus...</h2>
      <img src="assets/img/10491.jpg" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100" style="height: 60%;width: 35%;">

      <div class="btns">
        <a href="index.php?page=inscription" class="btn-get-started scrollto">Inscription</a>
        <a href="index.php?page=connexion" class="btn-get-started scrollto">Connexion</a>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="features" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          <h2>Fonctionnalites du systeme</h2>
          <p class="separator">Integer cursus bibendum augue ac cursus .</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              ...
              <h4>Sauvegarder la signature</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-md-9 col-lg-6">
              <form class="d-flex" method="POST" action="#">
                ...
                <button type="submit" class="btn btn-default"><i class="bi bi-location-arrow"></i>S'abonner </button>
              </form>
            </div>
          </div>
            ...
            <div class="form">
              <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                ...
                <div class="my-3">
                  ...
                  <div class="sent-message">Votre message a bien ete envoye. Merci!</div>
                </div>
  ...
  <footer class="footer">
    ...
    <div class="copyrights">
      <div class="container">
        <p>&copy; Tous droits à RENARD TEC</p>
        <div class="credits">
          <!--
